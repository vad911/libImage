...
public:
    ChannelView() = default;
    ChannelView(void* data, std::size_t width, std::size_t height, std::size_t strideBytes, ChannelElementDesc elementDesc);
    ...
    ChannelView subView(std::size_t x,std::size_t y,std::size_t w,std::size_t h) const;
